...
def install_opencl_intercept_layer(source_dir, prefix):
    name = 'opencl-intercept-layer'
...
def main() -> int:
    ...
    prefix = pwd.joinpath('out/opencl-intercept-layer')

    # install deps
    if args.install_deps:
        install_deps()

    install_opencl_intercept_layer(source_dir, prefix)
