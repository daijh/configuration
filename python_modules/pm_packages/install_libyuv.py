...
def install_libyuv(source_dir, prefix):
    name = 'libyuv'
    url = f'https://chromium.googlesource.com/libyuv/{name}'
    version = 'main'
    configure = f'-DCMAKE_INSTALL_PREFIX={prefix}'
...
def main() -> int:
    ...
    install_libyuv(source_dir, prefix)
